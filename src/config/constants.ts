...
export const CORE_LINK = 'https://layerxdao.io/'
export const PRESS_LINK = 'https://press.safe.global'
export const HELP_LINK = 'https://help.safe.global'
export const DOCS_LINK = 'https://wp.layerx.build/introducing-layerx/layerx'
export const FORUM_LINK = 'https://guild.xyz/layerx'
export const CHAT_LINK = 'https://taskon.xyz/campaign/detail/6223'
export const GUARDIANS_LINK = 'https://galxe.com/layerxdao/campaigns'
...
export const BRAND_KIT = 'https://t.me/layerxnews'
export const LICENSES_LINK = 'https://app.safe.global/licenses'
export const DEV_LINK = "https://discord.gg/5uFSepk87z";
export const ZELAY_LINK = "https://zealy.io/c/laxyerxdao/questboard";
export const COMMU_LINK = "https://layerxdao.io/community/";
export const STARTB_LINK = "https://layerxdao.io/community/";
export const RPCNODE_LINK = "https://layerx.host/";
export const TV_LINK = "https://layerx.tv/";
export const NETWORK_LINK = "https://status.layerx.build"; 
export const WALLET_ADDRESS_LINK = "https://status.layerx.build"; 
